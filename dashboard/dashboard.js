...
module.exports = async client => {
  ...
  app.use(
    session({
      ...
      secret:
        "#@%#&^$^$%@$^$&%#$%@#$%$^%&$%^#$%@#$%#E%#%@$FEErfgr3g#%GT%536c53cc6%5%tv%4ysjdhfoguiajgbiouashglifkawu4yrt934(*£&4(*£&$(*£&$^£4n",
      resave: false,
  ...
  // We bind the domain.
  app.locals.domain = "https://henrysbot.glitch.me";
  ...
  app.listen(3000, null, null, () =>
    console.log(`Dashboard is up and running on port 3000.`)
  );
};
